...
需求与决策记录见 `REQUIREMENTS.md`（v0.5）；**架构、数据现状、踩坑记录、下一步的权威文档是 `HANDOVER.md`**。

## 当前规模

**28 校 33 院系 4493 名导师**，逐字段 provenance（出处/抓取日期），方向 facet 13 类可筛选。各院系人数与字段覆盖率见 `HANDOVER.md` §6，或本地打开站点直接看。
